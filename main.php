...
\yeesoft\theme\assets\AdminLTEAsset::register($this);
//\yeesoft\theme\assets\CheckboxAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">iCheckbox</h3>
                        </div>
                        <div class="box-body">

                            <?= Html::checkbox('test', true, ['label' => 'Title']) ?>
                        </div>
                    </div>
                    <!-- /.box -->
